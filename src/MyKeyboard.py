...
def EngSymbolsDrawer(dict, surf_xcord, surface_ycord, surf_ycord, surface):
    ...
    Let_Drawer(tab_numb, consts, 0, wds_ind2, tab_dev, tab_mult, mult_UP)
    Let_Drawer(caps_numb, consts, 0, wds_ind2, cps_dev, cps_mult, mult_MD)
    Let_Drawer(l_shft_numb, consts, 0, wds_ind2, sft_dev, sft_mult, mult_DN)
    Let_Drawer(l_ctrl_numb, consts, 0, wds_ind1, ctrl_dev, ctrl_mult, mult_LW)
    Let_Drawer(alt_numb, consts, 0, wds_ind1, wds_dev1, alt_mult, mult_LW)
    Let_Drawer(altgr_numb, consts, 0, wds_ind1, wds_dev1, altg_mult, mult_LW)
    Let_Drawer(r_ctrl_numb, consts, 0, wds_ind1, wds_dev1, rctrl_mult, mult_LW)
    Let_Drawer(r_shft_numb, consts, 0, wds_ind2, kwc, rsft_mult, mult_DN)
    Let_Drawer(enter_numb, consts, 0, wds_ind2, kwc, ent_mult, mult_MD)
    Let_Drawer(back_numb, consts, 0, wds_ind2, kwc, bck_mult, mult_SK)
    Let_Drawer(str_line_numb, consts, indent1, indent1, kwc, str_mult, mult_UP)
    Let_Drawer(db_backsl_numb, consts, -indent2, -indent2 * indmult_f, slsh_dev, bdl_sl_mult, mult_MD)
    Let_Drawer(space_numb, consts, 0, wds_ind1, kwc, spc_mult, mult_LW)
